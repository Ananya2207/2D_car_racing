...
public class JavaApplication5 extends JPanel{
    ...
    public JavaApplication5(){
        ...
        car_x = car_y = 100;    //initialling setting the user's car location to (300,300)
    ...
    public void paint(Graphics g){
        ...
        try{
            //obj.drawImage(getToolkit().getImage("D:\\6th sem\\New folder\\car racing game\\images\\st_roadnew.png"), 0,0 ,this); //draw road on window
           obj.drawImage(getToolkit().getImage("D:\\6th sem\\New folder\\car racing game\\images\\st_road.png"), 0,0 ,this); //draw road on window
            //obj.drawImage(getToolkit().getImage("D:\\6th sem\\New folder\\car racing game\\images\\road.png"), 0,0 ,this); //draw road on window
                                                                                                                                                                           
            if(cry >= -499 && crx >= -499) {//if a road crossing has passed the window view
                obj.drawImage(getToolkit().getImage("D:\\6th sem\\New folder\\car racing game\\images\\cross_road.png"),crx,cry,this); //draw another road crossing on window
                   // obj.drawImage(getToolkit().getImage("D:\\6th sem\\New folder\\car racing game\\images\\cross_roadnew.png"),crx,cry,this); //draw another road crossing on window
            }
            obj.drawImage(getToolkit().getImage("D:\\6th sem\\New folder\\car racing game\\images\\car_right_1.png"),car_x,car_y,this);   //draw car on window
            
            if(isFinished){ //if collision occurs
                obj.drawImage(getToolkit().getImage("D:\\6th sem\\New folder\\car racing game\\images\\boom.png"),car_x-30,car_y-30,this); //draw explosion image on window at collision to indicate the collision has occured
            }
    ...
    void moveRoad(int count){
        if(crx == -999 && cry == -999){ //if the road crossing has passed by
            if(count%40 == 0){  //after a certain time
    ...
    public static void main(String args[]){
        ...
        JavaApplication5 game = new JavaApplication5(); //creating a new instance of a Game
        ...
        while(true){
            ...
            if(game.nOpponent < 4 && count % 200 == 0){ //if there is less than 4 cars and count timer reaches 200
                ...
                game.imageLoc[game.nOpponent] = "D:\\6th sem\\New folder\\car racing game\\images\\car_left_"+((int)((Math.random()*100)%3)+1)+".png"; //assign images to the opponent cars
